...
type ServiceProviderFiltersProps = {
    // values
    title: string;
    engagementId: string;
    isActive: boolean;
...
/**
 * Filters component for the Service Provider Workspace.
 * Similar to the generic Filters component but without the role selector
 * since the role is locked to "serviceProvider" for this workspace.
 */
